...
//                            System.out.println("row " + i + " column " + j + " is String type");
...
//                                    + " is Number type ; DateFormat:"
//                                    + value.toString());
                            break;
                        case XSSFCell.CELL_TYPE_BOOLEAN:
//                            System.out.println("row " + i + " column " + j + " is Boolean type");
                            value = Boolean.valueOf(cell.getBooleanCellValue());
                            break;
                        case XSSFCell.CELL_TYPE_BLANK:
//                            System.out.println("row " + i + " column " + j + " is Blank type");
                            value = "";
                            break;
                        default:
//                            System.out.println("row " + i + " column " + j + " is default type");
                            value = cell.toString();
                    }// end switch
                    colList.add(value);
                }//end for j
